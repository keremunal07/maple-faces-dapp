...
const Header = () => {
  ...
  return (
    <>
      <Head>
        <title>Maple Faces - NFT Platform</title>
        ...
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          ...
          <Link href="#">
            <a className="text-2xl font-bold">
              <span className="pr-2 text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-red-400">
                Maple
              </span>
              Faces
            </a>
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-6">
              <li>
                <a href="https://testnets.opensea.io/collection/maplefaces-v2" target="_blank" rel="noreferrer">
                  <svg
                    className="w-7 h-7"
                    viewBox="0 0 90 90"
                    fill="none"
              ...
              <li>
                <a href="https://twitter.com/keremmmunal" target="_blank" rel="noreferrer">
                  <svg
                    className="w-7 h-7"
                    stroke="currentColor"
                    fill="currentColor"
